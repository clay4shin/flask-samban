...
bp = Blueprint('cond6', __name__, url_prefix='/y2s1/cond6')
...
def result(participant_id):
    ...
    return render_template('y2s1/result_scorechat_eng.html', participant_id=participant_id, score_round=score_round, revised_comment=revised_comment, row=row, condition=6)
...
def revise(participant_id):
    ...
    return render_template('y2s1/revise_gun_neg_low.html', participant_id=participant_id, form=form, rr=rr, condition=6)
